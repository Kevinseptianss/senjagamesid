          ...
          <div className="bg-gray-800 p-4 rounded-lg border border-gray-600">
            ...
            <div className="space-y-2">
              <select
                ...
                onChange={(e) => handleArrayFilterChange('origin', Array.from(e.target.selectedOptions, option => option.value))}
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) => handleArrayFilterChange('genshin_character', Array.from(e.target.selectedOptions, option => option.value))}
                  ...
                  >
                    {genshinCharacters.map(char => (
                      <option key={char.value} value={char.value} className="bg-gray-700 text-white">
                        {char.label}
                      </option>
                    ))}
                  </select>
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) => handleArrayFilterChange('honkai_character', Array.from(e.target.selectedOptions, option => option.value))}
                    className="w-full px-3 py-2 bg-gray-700 border border-gray-600 rounded-lg text-white focus:border-purple-500 focus:outline-none max-h-32 overflow-y-auto"
                    size="4"
                  >
          ...
          <div className="bg-gray-800 p-4 rounded-lg border border-gray-600">
            ...
            <div className="space-y-2">
              <select
                ...
                onChange={(e) => handleArrayFilterChange('region', Array.from(e.target.selectedOptions, option => option.value))}
                className="w-full px-3 py-2 bg-gray-700 border border-gray-600 rounded-lg text-white focus:border-purple-500 focus:outline-none"
                size="3"
              >
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) => handleArrayFilterChange('zenless_character', Array.from(e.target.selectedOptions, option => option.value))}
                    className="w-full px-3 py-2 bg-gray-700 border border-gray-600 rounded-lg text-white focus:border-purple-500 focus:outline-none max-h-32 overflow-y-auto"
                    size="4"
                  >
