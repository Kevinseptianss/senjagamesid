...
const PaymentModal = ({ isOpen, onClose, item, quantity = 1 }) => {
  ...
  const [customerName, setCustomerName] = useState(user?.fullName || user?.email?.split('@')[0] || '');
  ...
  const getPriceValue = () => {
    ...
    if (item.price) {
      ...
      return typeof item.price === 'number' ? item.price : parseFloat(item.price.toString().replace(/[$,]/g, ''));
    }
    return 0;
  };
            ...
            <div className="bg-gray-800/50 rounded-lg p-4 border border-gray-700">
              ...
              <div className="bg-blue-900/20 border border-blue-500/30 rounded-lg p-3 mt-4">
                <div className="text-xs text-blue-300">
                  ...
                  Kurs: 1 USD = {formatCurrency(import.meta.env.VITE_USD_TO_IDR_RATE || 15500).replace('Rp', '')} IDR
                </div>
              </div>
            </div>
                  ...
                  >
                    ...
                    {selectedChannel === channel.code && (
                      <Icon
                        ...
                        className="text-purple-400 ml-auto text-xl"
                      />
                    )}
                  </label>
                ))}
          ...
          <div className="p-6">
            {paymentResult.success ? (
              <div className="text-center space-y-6">
                ...
                <div>
                  <h3 className="text-xl font-bold text-white mb-2">Virtual Account Berhasil Dibuat!</h3>
                  <p className="text-gray-400">Silakan transfer ke nomor virtual account berikut:</p>
                </div>
                ...
                <div className="bg-gray-800/50 rounded-lg p-6 border border-gray-700 space-y-4">
                  ...
                  <div className="grid grid-cols-2 gap-4 text-sm">
                    <div>
                      ...
                      <div className="text-white font-medium">{paymentResult.virtualAccountName}</div>
                    </div>
                    <div>
                      <div className="text-gray-400">Jumlah</div>
                      <div className="text-white font-medium">{formatCurrency(paymentResult.amount)}</div>
                    </div>
                    <div>
                ...
                <div className="bg-blue-600/20 border border-blue-500/30 rounded-lg p-4">
                  <div className="flex items-start">
                    ...
                    <div className="text-sm text-blue-200">
                      <div className="font-medium mb-2">Cara Pembayaran {paymentResult.channel}:</div>
