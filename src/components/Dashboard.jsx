              ...
              <div className="flex items-center space-x-2 sm:space-x-4">
                ...
                <div className="hidden lg:block">
                  <span className="text-gray-300 text-sm">
                    Dashboard - <span className="text-purple-400 font-medium">{user?.fullName || user?.email.split('@')[0]}</span>
                  </span>
                </div>
        ...
        <div className="bg-gray-900/80 backdrop-blur-md border border-gray-800 rounded-xl p-6 mb-6 shadow-xl">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
            <div>
              ...
              <p className="text-gray-300 text-sm sm:text-base">Kelola akun yang sudah dibeli dan transaksi yang sedang berlangsung</p>
            </div>
            ...
            <nav className="flex overflow-x-auto">
              ...
              >
                <div className="flex items-center justify-center space-x-2">
                  ...
                  <span className="bg-gray-700 text-white text-xs px-2 py-1 rounded-full">{purchasedAccounts.length}</span>
                </div>
              </button>
              <button
              ...
              >
                <div className="flex items-center justify-center space-x-2">
                  ...
                  <span className="bg-gray-700 text-white text-xs px-2 py-1 rounded-full">{ongoingTransactions.length}</span>
                </div>
              </button>
            </nav>
          </div>
              ...
              <div>
                {purchasedAccounts.length === 0 ? (
                  <div className="text-center py-12">
                    ...
                    <p className="text-gray-400 mb-6 max-w-md mx-auto">Mulai jelajahi berbagai akun gaming berkualitas dengan harga terjangkau</p>
                    <Link
                      to="/"
                  ...
                  <div className="grid gap-4 sm:gap-6">
                    {purchasedAccounts.map((account, index) => (
                      <div key={index} className="bg-gray-800/50 border border-gray-700/50 rounded-xl p-4 sm:p-6 hover:border-purple-500/50 transition-all duration-200">
                        <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between">
                          <div className="flex-1">
                            <div className="flex items-start space-x-3">
                              <div className="bg-purple-600/20 p-2 rounded-lg">
                                <Icon icon="mdi:gamepad-variant" className="text-purple-400 text-xl" />
                              </div>
                              <div className="flex-1">
              ...
              <div>
                {ongoingTransactions.length === 0 ? (
                  <div className="text-center py-12">
                    ...
                    <h3 className="text-lg font-medium text-white mb-2">Tidak Ada Transaksi Berlangsung</h3>
                    <p className="text-gray-400 mb-6 max-w-md mx-auto">Semua transaksi Anda telah selesai. Siap untuk berbelanja lagi?</p>
                    <Link
                      to="/"
                      className="inline-flex items-center bg-gradient-to-r from-purple-600 to-purple-700 text-white px-6 py-3 rounded-lg hover:from-purple-700 hover:to-purple-800 transition-all duration-200 font-medium shadow-lg hover:shadow-purple-500/25"
                    >
