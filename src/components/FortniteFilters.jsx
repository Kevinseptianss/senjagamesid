...
const FortniteFilters = ({ onFiltersChange, initialFilters = {} }) => {
  ...
  const { cosmeticItems, loading: cosmeticLoading, error: cosmeticError } = useFortniteCosmeticItems();
  ...
  const orderByOptions = [
    ...
    { value: 'likes_to_down', label: 'Most Liked' },
    { value: 'likes_to_up', label: 'Least Liked' }
  ];
