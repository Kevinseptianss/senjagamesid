    ...
    return (
      <div className="account-container">
        {[...Array(12)].map((_, index) => (
          <div key={index} className="account bg-gray-900 rounded-lg border border-gray-700 p-6 animate-pulse">
  ...
  if (accountsWithGames.length === 0) {
    return (
      <div className="text-center py-12">
        ...
        <p className="text-gray-500 text-sm mt-2">Found {accounts.length} accounts, but none have games data</p>
      </div>
    )
  }
