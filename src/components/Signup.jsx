  ...
  const handleOtpSubmit = async (e) => {
    ...
    try {
      ...
      if (error.code === 'auth/configuration-not-found') {
        ...
        errorMessage = 'Email sudah digunakan. Silakan gunakan email lain atau masuk ke akun yang sudah ada.';
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-sm mt-1">
                        Gunakan kode OTP: <span className="font-mono font-bold text-yellow-100">{DEV_OTP}</span>
                      </p>
                    </div>
                  </div>
                </div>
