        ...
        <div className="p-6 space-y-6">
          ...
          <div className="bg-gray-800/50 rounded-lg p-4 border border-gray-700">
            ...
            <div className="space-y-3 text-sm">
              ...
              <div className="flex justify-between">
                ...
                <span className="text-white font-medium">{transaction.item?.title || 'Gaming Account'}</span>
              </div>
              <div className="flex justify-between">
              ...
              <div className="flex items-start">
                ...
                <div className="text-sm text-red-200">
                  ...
                  <p className="text-red-300 mb-3">
                    Virtual Account ini sudah kadaluarsa. Anda dapat membuat virtual account baru dengan metode pembayaran yang sama atau berbeda.
                  </p>
                  <button
          ...
          <div className="bg-gray-800/50 rounded-lg p-4 border border-gray-700">
            ...
            <button
              ...
              disabled={isProcessing || !customerName.trim() || selectedChannel === transaction.channel}
