...
const SearchableCosmeticDropdown = ({ 
  ...
  const getTypeIcon = () => {
    switch(type) {
      case 'skins': return 'game-icons:leather-armor';
      case 'pickaxes': return 'game-icons:mining';
      case 'emotes': return 'game-icons:dance';
      case 'gliders': return 'game-icons:parachute';
      default: return 'game-icons:chest-armor';
    }
  };
                ...
                filteredItems.map((item) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      {isSelected && (
                        <Icon icon="material-symbols:check" className="w-4 h-4 text-purple-400 flex-shrink-0 ml-2" />
                      )}
                    </button>
                  );
                })
